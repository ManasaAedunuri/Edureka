...
//        String stepName = scenario.getName(); // Or use scenario.getStatus() for status
//        String screenshotPath = Reports.captureScreenshot(driver, stepName);
//
//        try {
//            test.log(Status.INFO, "Step executed: " + stepName,
//                    MediaEntityBuilder.createScreenCaptureFromPath(screenshotPath).build());
//            } catch (Exception e) {
//            	     e.printStackTrace();
//                 test.log(Status.INFO, "Screenshot failed for step: " + stepName);
//        }
//    }
//
// 
