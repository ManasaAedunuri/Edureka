...
public class Reviews extends BaseSteps {
	...
	boolean isVisible;
//
//	@When("the user clicks on the Reviews section")
...
//	}
	@When("the user clicks on the  Reviews section")
	public void the_user_clicks_on_the_reviews_section() {
...
//	@Then("the Reviews page should be displayed")
...
//	}
	@Then("the  Reviews page should be displayed")
	public void the_reviews_page_should_be_displayed() {
try {
